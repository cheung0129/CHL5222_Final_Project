...
table(ethiopia_old$drwaterq_new, ethiopia_old$round, useNA = "ifany")
...
# scaled residuals magnitude -> outliers?
# boxplot(ethiopia_old$zhfa)
# 
# # identify large outcome values as potential outliers
# ethiopia_old %>% arrange(zhfa)
# ethiopia_old %>% filter(childid == "ET130076")
